...
export function Header() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-5 left-1/2 transform -translate-x-1/2 z-100 flex flex-col items-center
    ...
    >
      <div className="flex items-center justify-between w-full gap-x-6 sm:gap-x-8">
        <div className="flex items-center">
          ...
          <b className="pl-4 text-lg text-neutral-200">OPEN DOCS PRO</b>
        </div>
          ...
          {!user ? (
            <>
              ...
              <button
                ...
                className="px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-linear-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200"
              >
                Sign Up
              </button>
            </>
            ...
            {!user ? (
              <>
                ...
                <button
                  ...
                  className="w-full py-2 font-semibold text-black bg-linear-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200"
                >
                  Sign Up
                </button>
              </>

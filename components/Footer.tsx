        ...
        >
          <div className='flex flex-col items-center'>
            ...
            >
                ...
                <img src='/logo/bun.svg' className='h-5' />
                <img src='/logo/prisma-2.svg' className='h-4' />
                <img src='/logo/postgresql.svg' className='h-4' />
                {/* <img src='/neondb.svg' className='h-4' /> */}
                <img src='https://cdn.worldvectorlogo.com/logos/gemini-icon-logo.svg' className='h-4' />
                <img src='/logo/razorpay.svg' className='h-4' />
